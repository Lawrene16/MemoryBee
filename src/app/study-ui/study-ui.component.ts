...
@Component({
  selector: "app-study-ui",
  templateUrl: "./study-ui.component.html",
  styleUrls: ["./study-ui.component.scss"],
})
export class StudyUiComponent {
  ...
  constructor(
    ...
    setTimeout(() => {
      ...
      let tinderCardElement = document.getElementById("studycards");
